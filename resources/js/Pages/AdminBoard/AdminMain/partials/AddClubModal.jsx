...
export default function AddClubModal({ isModalOpen, setIsModalOpen, setClubs }) {
    ...
    async function handleAddClub()  {
        try {
            ...
            console.error(error);
            toast(`Error inserting new club '${newClubInfo.name}', are you admin?`, {
                icon: '❌'
            });
        }
    };
