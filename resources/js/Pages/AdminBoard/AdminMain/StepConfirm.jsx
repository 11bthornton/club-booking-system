            ...
            <div className="mt-4">
                ...
                <div>
                    <Typography variant="body1">
                        <strong>Start Time: </strong> {formData.start_time || 'N/A'}
                    </Typography>
                </div>
                <div>
                    <Typography variant="body1">
                ...
                <div>
                    <Typography variant="body1">
                        <strong>Year Groups: </strong> {formData.year_groups.length > 0 ? formData.year_groups.join(', ') : 'N/A'}
                    </Typography>
                </div>
                <div>
                    <Typography variant="body1">
                        <strong>Clubs: </strong> {formData.clubs.length > 0 ? formData.clubs.join(', ') : 'N/A'}
                    </Typography>
                </div>
            </div>
        </>
