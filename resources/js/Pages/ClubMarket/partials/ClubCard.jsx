...
export function ClubCard({
    ...
    return (
        <Card
            variant="outlined"
            className={`card-animation ${animationClass} ${
                    ...
                    >
                        {club ? (
                            ...
                            <Alert severity="warning">
                                You haven't selected a club for this day yet.
                                You will be allocated "Home" if left unchecked
                            </Alert>
                        )}
                    </Typography>
                </CardContent>
