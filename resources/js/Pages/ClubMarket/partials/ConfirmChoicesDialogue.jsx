...
export default function ConfirmChoicesDialogue({
    changeInfoModalOpen,
    selectedChangeInfo,
    selectedInstanceToBook,
    ...
    return (
        ...
        >
            <Box className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-1/3 bg-white shadow-xl p-10 rounded-lg">
                <h2
                ...
                {selectedChangeInfo.clubsToDelete ? (
                    <Alert severity="warning" className="mb-4">
                        Going ahead will delete one or more of your existing
                        bookings
                    </Alert>
                ) : (
                    <></>
                ...
                <div className="flex justify-center gap-10">
                    <div className="">
                        <p className="text-green-500 mb-3">
                            Clubs to Book:{" "}
                            {selectedChangeInfo.clubsToBook?.join(", ")}
                        </p>
                    </div>
                    ...
                    <div>
                        <p className="text-red-500 mb-5">
                            Clubs to Remove:{" "}
                            {selectedChangeInfo.clubsToDelete?.join(", ")}
                        </p>
                    </div>
                </div>
                ...
                <div className="flex justify-center items-center gap-5">
                    <Button
                        ...
                        onClick={() => {
                            const notify = toast
                                .promise(postClub(selectedInstanceToBook), {
                                ...
                                .then((response) => {
                                    ...
                                    const newBookedClubs =
                                        response.data.alreadyBookedOn;

                                    setAvailableClubs(
                                        response.data.availableClubs,
                                    );
                                    setClubSelections(
                                        Object.values(newBookedClubs),
                                    );
