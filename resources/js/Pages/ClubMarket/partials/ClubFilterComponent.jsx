...
export function ClubFilterComponent({ availableClubs, setAvailableClubs, activeStep, clubSelections, setClubSelections, bookClub, handleBack, handleNext, steps, removeClub }) {
